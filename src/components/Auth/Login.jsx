            ...
            <div className="form-control">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`input input-bordered w-full pl-3 transition-all focus:border-primary focus:ring-1 focus:ring-primary ${
            ...
            <div className="form-control">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="••••••••••••••••"
                  className={`input input-bordered w-full pl-3 pr-10 transition-all focus:border-primary focus:ring-1 focus:ring-primary ${
