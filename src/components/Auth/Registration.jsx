    ...
    <div className="min-h-screen w-full flex bg-base-100 font-sans">
      ...
      <div className="hidden lg:flex w-1/2 bg-primary relative overflow-hidden items-center justify-center">
        ...
        <div className="relative z-10 text-center text-white px-10">
          <h1 className="text-5xl font-black mb-4 tracking-tight drop-shadow-md">
            Hero Kidz
          </h1>
          <p className="text-lg opacity-90 max-w-md mx-auto leading-relaxed">
            Start your child's journey with us. Creating an account gives you access to premium resources.
          </p>
        ...
        <div className="w-full max-w-md space-y-6">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            <div className="form-control">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`input input-bordered w-full pl-3 h-11 transition-all focus:border-primary focus:ring-1 focus:ring-primary ${
            ...
            <div className="form-control">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className={`input input-bordered w-full pl-3 pr-10 h-11 transition-all focus:border-primary focus:ring-1 focus:ring-primary ${
            ...
            <button
              ...
              className="btn btn-primary w-full text-white font-bold text-lg shadow-lg mt-2 disabled:bg-gray-300"
            >
          ...
          <div className="relative flex py-2 items-center">
            ...
            <span className="flex-shrink-0 mx-4 text-gray-400 text-xs uppercase font-medium">Or join with</span>
            <div className="flex-grow border-t border-gray-300"></div>
          </div>

          <div className="grid grid-cols-2 gap-4">
            <button className="btn btn-outline border-gray-300 hover:bg-gray-50 text-gray-700 gap-2 h-11 min-h-0">
